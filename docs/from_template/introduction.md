...
- A **results** directory for collecting scripts
  that derive results, tables and figures from the dataset,
...
- An **upload** directory.
  Once the workflow has been executed,
  it will contain the files for uploading to a publisher, preprint server, conference website, etc.
